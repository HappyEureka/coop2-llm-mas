"""End-to-end test of the CUBE condition runner with a scripted LLM client.
...
def _args(topology: str, output_root: str, **overrides) -> argparse.Namespace:
    values = dict(
        ...
        grid_size=15, coop2_repair=False, quiet=True, llm_quiet=True, show=False, record_video=False,
